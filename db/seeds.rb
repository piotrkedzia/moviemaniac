...
Review.create!([
  {
    name: "Stachu",
    stars: 4,
    comment: "It was fantastic movie",
    movie_id: 1
  },
  {
    name: "John Zalewski",
    stars: 5,
    comment: "I have never seen so boring movie",
    movie_id: 1
  },
  {
    name: "Angelika",
    stars: 5,
    comment: "Very nice movie. I'm glad that i can saw it"
  }
])
...
movie.reviews.create!(name: "Elvis Mitchell", stars: 5, comment: "It's a bird, it's ")

# Add few Users
logins = %w"testuser johndoe pitter damian"

logins.each { |login| User.create!(email: "#{login}@gmail.com", password: login*2) }
